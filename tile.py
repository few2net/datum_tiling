...
def _tile_polygon(
    ...
    if inter.geom_type == "Polygon":
        ...
        anns = []
        for g in geoms:
            a = Polygon(points=[p for xy in g.exterior.coords for p in xy], attributes=deepcopy(ann.attributes))  # annotation
            anns.append(a)
        return anns
    else:
        # Skip non-area geometries like LineString or Point
        return None
